        ...
        <div class="col-span-12 md:col-span-8 border border-slate-200 rounded-md p-4">
            ...
            <div class="pt-4 md:pt-8">
                <p class="text-md text-slate-500">
                    CHG is a leading mental health hospital dedicated to providing evidence based mental health services in
                    Africa and beyond. We are seeking a talented and dedicated Data Analyst to join our team. The ideal candidate
                    will possess a strong analytical background and understanding of healthcare data systems.
                    The successful candidate will play a vital role in analyzing healthcare data to identify trends, patterns, and
            ...
            <div class="pt-4 md:pt-8">
                ...
                <ul class="list-disc pl-4">
                    <li class="text-md text-slate-500">
                        Extract, transform, and analyze healthcare data from various sources, including electronic health records
                    </li>
                    <li class="text-md text-slate-500">
                        Develop and maintain dashboards, reports, and visualizations to track key performance indicators (KPIs) related to patient outcomes, treatment efficacy, and healthcare utilization.
                    </li>
                    <li class="text-md text-slate-500">
                        Collaborate with clinicians and administrators to understand business requirements and translate them into actionable data analysis tasks.
                    </li>

                    <li class="text-md text-slate-500">
                        Conduct statistical analysis and predictive modeling to identify hospital services opportunities, clinical risk factors, patient outcomes, and inform clinical and management decision-making.
                    </li>
                    <li class="text-md text-slate-500">
                        Assist in the design and implementation of data quality initiatives to ensure the accuracy and integrity of healthcare data.
                    </li>
                </ul>
            </div>
            ...
            <div class="pt-4 md:pt-8">
                ...
                <ul class="list-disc pl-4">
                    ...
                    <li class="text-md text-slate-500">
                        High performance in mathematics at the high school level, with a strong understanding of statistical concepts and methods.
                    </li>
                    <li class="text-md text-slate-500">
                        Minimum of 2 years of experience working as a Data Analyst in the healthcare industry, preferably in mental health settings.
                    </li>
                    <li class="text-md text-slate-500">
                        Proficiency in advanced Excel, SQL, R, or other data analysis systems.
                    </li>
                    <li class="text-md text-slate-500">
                        Experience with healthcare data standards and protocols.
                    </li>
                    <li class="text-md text-slate-500">
                    ...
                    <li class="text-md text-slate-500">
                        Passion for improving patient outcomes and advancing mental health research through data analysis.
                    </li>
            ...
            <div class="pt-4 md:pt-8">
                ...
                <p class="font-semibold text-md text-slate-500">
                    We recruit on a rolling basis and can close the procedure early if there are sufficient suitable candidates on or before March 20, 2024.
                    We therefore encourage early applications. Only shortlisted applicants will be contacted.

                    If you are passionate about using data to drive positive change in mental health and are excited to join a collaborative and mission-driven team, we encourage you to apply for this rewarding opportunity.
                </p>
            </div>
