...
<div class="w-full h-screen flex flex-col lg:flex-row items-center justify-center space-y-16 lg:space-y-0 space-x-8 2xl:space-x-0">
    <div class="w-full lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
        <p class="text-4xl md:text-5xl lg:text-6xl font-bold tracking-wider text-gray-300">The page is coming soon</p>
        <p class="text-lg md:text-xl lg:text-2xl text-gray-500 my-12 my-10">Sorry, the page you are looking for is under maintenance.</p>
        <a href="<?= base_url() ?>" class="flex items-center space-x-2 bg-[#0060a3] text-white px-4 py-2 rounded transition duration-150" title="Return Home">
    ...
    <div class="w-1/2 lg:h-full flex lg:items-end justify-center p-4">
        ...
        <div class="">
            ...
            <svg version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                 width="200px" height="200px" fill="#0060a3"  viewBox="0 0 512 512" xml:space="preserve" class="absolute bottom-0">
            <g>
