<section class="dashboard">
    ...
    <div class="pt-20 flex items-center justify-between">
        ...
        <div>
            ...
            <span class="font-medium text-2xl ml-2">Create Assessment Question</span>
        </div>
        <div class="icon-color py-1 px-3 rounded-lg bg-blue-100">
            <ul>
                ...
                <li class="inline-block">
                    <span class="text-blue-700">Assessment Questions</span>
                </li>
            </ul>
        </div>
    ...
    <div class="pt-4">
        <button id="openNewAssessmentQuestion"
    ...
    <div id="assessmentQuestionContent" class="mt-5 bg-gray-50 p-3 rounded-md overflow-x-auto">
        <table class="cell-border hover stripe display nowrap" id="manageAssessmentQuestionDataTable" style="width: 100%">
    ...
    <!-- Add New Role modal -->
    <div id="newQuestionModel" class="relative z-10 hidden" aria-labelledby="modal-title" role="dialog" aria-modal="true">
                    ...
                    <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                        <div class="sm:flex sm:items-start">
                            ...
                            <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                <h3 class="text-base font-semibold leading-6 text-gray-900" id="modal-title">Assessment Question</h3>
                            </div>
                        </div>

                        <input type="hidden" id="assessmentQuestionId">
                        ...
                        <label class="block pt-2 w-full">
                            ...
                            <input type="text" id="assessmentQuestion" class="input input-bordered w-full"/>
                        ...
                        <label class="block pt-2 w-full">
                            ...
                            <textarea id="assessmentQuestionDescription" class="textarea textarea-bordered w-full placeholder:text-stone-400" placeholder="Assessment Category Description"></textarea>
                            <span id="assessmentQuestionDescriptionError" class="text-xs text-red-500 pt-2"></span>
                        </label>

                    </div>
                    <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                        <button type="button" id="createQuestion"
                        ...
                        <button type="button" id="closeQuestionModal"
