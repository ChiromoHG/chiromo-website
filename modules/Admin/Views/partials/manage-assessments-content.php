<section class="dashboard">
    ...
    <div class="pt-20 flex items-center">
        ...
        <span class="font-medium text-2xl ml-2">Manage Assessments</span>
    </div>

    <div class="container mx-auto pt-4" x-data="{ activeTab: 'suicide' }">
        <div class="flex">
            <div class="flex start">
                <button class="py-2 px-0 text-lg hover:text-gray-700"
                        :class="{ 'text-blue-700': activeTab === 'suicide' }"
                        x-on:click="activeTab = 'suicide'">Suiside
                </button>
                <button class="py-2 px-4  text-lg hover:text-gray-700"
                        :class="{ 'text-blue-700': activeTab === 'depression' }"
                        x-on:click="activeTab = 'depression'" id="display-depression">Depression
                </button>

                <button class="py-2 px-4  text-lg hover:text-gray-700"
                        :class="{ 'text-blue-700': activeTab === 'anxiety' }"
                        x-on:click="activeTab = 'anxiety'" id="display-anxiety">Anxiety
                </button>


                <button class="py-2 px-4  text-lg hover:text-gray-700"
                        :class="{ 'text-blue-700': activeTab === 'burnout' }"
                        x-on:click="activeTab = 'burnout'" id="display-burnout">Burnout
                </button>

                <button class="py-2 px-4  text-lg hover:text-gray-700"
                        :class="{ 'text-blue-700': activeTab === 'alcohol' }"
                        x-on:click="activeTab = 'alcohol'" id="display-alcohol">Alcohol
                </button>

                <button class="py-2 px-4  text-lg hover:text-gray-700"
                        :class="{ 'text-blue-700': activeTab === 'ptsd' }"
                        x-on:click="activeTab = 'ptsd'" id="display-pdst">PDST
                </button>
            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg mt-10 bg-gray-50" id="usersContent" x-show="activeTab === 'suicide'">
        ...
        <div id="rolesContent" class="mt-5 bg-gray-50 p-3 rounded-md overflow-x-auto" x-show="activeTab === 'depression'" style="display: none">
